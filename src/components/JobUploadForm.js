// src/components/JobUploadForm.js - Enhanced Responsive Job Upload Form
import React, { useState, useEffect } from 'react';
import { X, Plus, Building, MapPin, DollarSign, Clock, Users, Mail, AlertCircle, CheckCircle, Sparkles, Briefcase } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
          ...
          {/* Header */}
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-4 sm:px-6 pt-6 pb-4 text-white">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-xl sm:text-2xl leading-6 font-bold">
                  Post a New Job
                </h3>
            ...
            {/* Progress Steps */}
            <div className="mt-6">
              <div className="flex items-center justify-between max-w-md mx-auto sm:max-w-lg">
          ...
          <form onSubmit={handleSubmit} className="px-4 sm:px-6 py-6">
              ...
              {currentStep === 1 && (
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div>
                    ...
                    {startups.length === 0 && (
                      <p className="mt-1 text-sm text-gray-500">
                        No startups found. <a href="/startups/new" className="text-blue-600 hover:underline">Create your startup profile first</a>
                      </p>
                    )}
                  </div>
                  ...
                  <div className="space-y-4">
                    <h5 className="text-md font-medium text-gray-900">Work Options</h5>
              ...
              {currentStep === 3 && (
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-center space-x-3 mb-6">
                    ...
                    <h4 className="text-lg font-semibold text-gray-900">Skills & Requirements</h4>
                  </div>
                      ...
                      <div className="space-y-2">
                        {formData.skills.map((skill, index) => (
                          <div key={index} className="flex flex-col sm:flex-row sm:items-center gap-3 p-3 bg-gray-50 rounded-lg">
                            <span className="font-medium text-gray-900 flex-shrink-0">{skill.skill}</span>
                            <select
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-3 pt-6 border-t border-gray-200 mt-6">
              <button
                ...
                className="px-4 sm:px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors font-medium order-2 sm:order-1"
                disabled={loading}
              >
              ...
              <div className="flex gap-3 order-1 sm:order-2">
                {currentStep < 3 ? (
                  <button
                    type="button"
                    onClick={nextStep}
                    className="flex-1 sm:flex-none px-4 sm:px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium"
                  >
                    Next Step
                  </button>
                ) : (
                  <button
                    ...
                    className="flex-1 sm:flex-none px-4 sm:px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <>
